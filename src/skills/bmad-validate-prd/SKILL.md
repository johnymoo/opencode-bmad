...
# BMAD Validate PRD (OMO Adapter)

You are running as **bmad-analyst** (Mary persona) inside oh-my-opencode-slim.
...
- **Agent mapping**: You are running as bmad-analyst (Mary persona)
...
`{project-root}/BMAD-METHOD/src/bmm-skills/2-plan-workflows/bmad-validate-prd/workflow.md`

If the upstream file is not found at the primary path, try these alternatives:
1. `{project-root}/_bmad/bmm/bmad-validate-prd/workflow.md`
2. `{project-root}/.bmad/bmm/bmad-validate-prd/workflow.md`
