...
argument-hint: "<epic-number> e.g., 1 or 2 (optional)"
---

# BMAD Retrospective (OMO Adapter)
...
- **Agent mapping**: You are running as bmad-sm (Sprint Manager) facilitating retrospective
...
`{project-root}/BMAD-METHOD/src/bmm-skills/4-implementation/bmad-retrospective/workflow.md`

If the upstream file is not found at the primary path, try these alternatives:
1. `{project-root}/_bmad/bmm/bmad-retrospective/workflow.md`
2. `{project-root}/.bmad/bmm/bmad-retrospective/workflow.md`
