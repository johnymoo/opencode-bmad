...
description: "Generate Acceptance Test-Driven Development (ATDD) test checklist for a story"
argument-hint: "<story-number> e.g., 1-1 or 2-3"
---

# BMAD TestArch ATDD (OMO Shim)
...
This is an OMO-native compatibility shim. The upstream BMAD-METHOD does not include a `testarch-atdd` workflow — the ATDD methodology belongs to BMAD's separate TEA (Test Engineering Architecture) module. This shim provides a minimal ATDD workflow so Phase 1 pipelines work unchanged.
...
1. `{project-root}/_bmad/tea/bmad-testarch-atdd/workflow.md`
2. `{project-root}/.bmad/tea/bmad-testarch-atdd/workflow.md`
