...
# BMAD Create Architecture (OMO Adapter)
...
`{project-root}/BMAD-METHOD/src/bmm-skills/3-solutioning/bmad-create-architecture/workflow.md`

If the upstream file is not found at the primary path, try these alternatives:
1. `{project-root}/_bmad/bmm/bmad-create-architecture/workflow.md`
2. `{project-root}/.bmad/bmm/bmad-create-architecture/workflow.md`
