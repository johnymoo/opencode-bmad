...
`{project-root}/BMAD-METHOD/src/bmm-skills/2-plan-workflows/bmad-edit-prd/workflow.md`

If the upstream file is not found at the primary path, try these alternatives:
1. `{project-root}/_bmad/bmm/bmad-edit-prd/workflow.md`
2. `{project-root}/.bmad/bmm/bmad-edit-prd/workflow.md`
