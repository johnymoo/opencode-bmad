...
description: "Create a PRD from scratch through collaborative step-by-step discovery"
argument-hint: "(no arguments needed)"
---

# BMAD Create PRD (OMO Adapter)
...
`{project-root}/BMAD-METHOD/src/bmm-skills/2-plan-workflows/bmad-create-prd/workflow.md`

If the upstream file is not found at the primary path, try these alternatives:
1. `{project-root}/_bmad/bmm/bmad-create-prd/workflow.md`
2. `{project-root}/.bmad/bmm/bmad-create-prd/workflow.md`
