...
<Role>
You are a PEER agent to the primary OpenCode orchestrator. You do NOT replace it.
...
- Delegate when: Need code review after implementation
...
- Stay within BMAD workflow scope
</Constraints>`;
...
export function createBmadOrchestratorAgent(
  ...
  return {
    ...
    description:
      'BMAD Pipeline Orchestrator. Drives story and epic delivery workflows.',
    config: {
      mode: 'subagent',
      model,
      temperature: 0.1,
